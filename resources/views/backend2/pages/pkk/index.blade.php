                    ...
                    <div class="app-action-panel" id="contacts-action-panel">
                        ...
                        <div id="categories-list" class="app-actions-list scrollable-container">
                            <div class="list-group">
                                <a href="{{ route('admin.pkk.index') }}" class="list-group-item">
                                    <i class="fa fa-inbox text-color m-r-xs"></i>
                                    <span>Semua Surat</span>
                                </a>
                            </div><!-- .list-group -->

                            <hr class="m-b-md m-0" style="border-color: #ddd;">

                            <div class="list-group">
                                @foreach ($categories as $category)
                                    <div class="list-group-item">
                                        <div class="item-data" style="width: 100%;"
                                            onclick="window.location.href='{{ route('admin.pkk.category', $category->id) }}'">
                                    ...
                                    <div id="editcategory{{ $category->id }}" class="modal fade" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.pkk.category.update', $category->id) }}"
                                    ...
                                    <div id="deletecategory{{ $category->id }}" class="modal fade" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="{{ route('admin.pkk.category.delete', $category->id) }}""
                ...
                <div class="col-md-10">
                    ...
                    <div id="contacts-list" class="row">
                        @foreach ($suratpkks as $suratpkk)
                                ...
                                <div class="card user-card contact-item p-md">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading title-color">{{ $suratpkk->name }}</h5>
                                            <small class="media-meta">{{ $suratpkk->description }}</small>
                                        </div>
                                    </div>
                                    <div class="contact-item-actions">
                                        @can('sotk.create')
                                            <a href="javascript:void(0)" class="btn btn-success" data-toggle="modal"
                                                data-target="#editsuratsotk{{ $suratpkk->id }}"><i
                                                    class="fa fa-edit"></i></a>
                                            <a href="javascript:void(0)" class="btn btn-danger" data-toggle="modal"
                                                data-target="#deletesuratsotk{{ $suratpkk->id }}"><i
                                                    class="fa fa-trash"></i></a>
                                        @endcan
                                        <a href="{{ asset($suratpkk->path_file) }}" target="blank"
                            ...
                            <!-- edit surat  Modal -->
                            <div id="editsuratsotk{{ $suratpkk->id }}" class="modal fade" tabindex="-1"
                                role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form action="{{ route('admin.pkk.update', $suratpkk->id) }}"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <textarea name="description" class="form-control" placeholder="Deskripsi Surat">{{ $suratpkk->description }}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <select name="category" class="form-control" required>
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                @selected($category->id == $suratpkk->category_id)>{{ $category->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                            ...
                            {{-- delete surat modal --}}
                            <div id="deletesuratsotk{{ $suratpkk->id }}" class="modal fade" tabindex="-1"
                                role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <h5>hapus surat {{ $suratpkk->name }}</h5>
                                        </div><!-- .modal-body -->
                                        <form class="modal-footer"
                                            action="{{ route('admin.pkk.destroy', $suratpkk->id) }}" method="post">
                                            @method('delete')
                                            @csrf
    ...
    <div id="categoryModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.pkk.category.store') }}" id="newCategoryForm" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group m-0">
