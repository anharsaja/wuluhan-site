...
class DokumentasiTrantibController extends Controller
{
    public function index()
    {
        $category = CategoryDokumentasiTrantib::get();
        $surat = DokumentasiTrantib::get();
        return view('backend2.pages.dokumentasi.index', ['categories' => $category, 'surats' => $surat, 'title' => 'Dokumentasi Trantib', 'name' => 'trantib.dokumentasi']);
    }
    ...
    public function indexPublic()
    {
        ...
        return view('backend2.pages.dokumentasi.index', ['categories' => $category, 'surats' => $surat, 'title' => 'Dokumentasi Trantib - Public', 'name' => 'trantib.dokumentasi']);
    }
        ...
        public function indexPrivate()
    {
        ...
        return view('backend2.pages.dokumentasi.index', ['categories' => $category, 'surats' => $surat, 'title' => 'Dokumentasi Trantib - Private', 'name' => 'trantib.dokumentasi']);
    }
    ...
    public function category($id)
    {
        try {
            ...
            return view('backend2.pages.dokumentasi.index', ['categories' => $category, 'surats' => $surat, 'title' => 'Dokumentasi Trantib', 'categoryName' => $categoryName, 'name' => 'trantib.dokumentasi']);
        } catch (\Throwable $th) {
    ...
    public function blogShow () {
        $blogs = DokumentasiTrantib::where('status', 'public')->get();
        $name = 'trantib';
    ...
    {
        try {
            $blogs = DokumentasiTrantib::findOrfail($id);
            $name = 'trantib';
    ...
    public function store(Request $request)
    {
        ...
        if ($check1 || $check2 || $check3) {
            ...
            $files1->move(public_path() . '/kumpulan_surat/file_dokumentasi_trantib', $filename1);
            $filename2 = time() . '_2.' . $extension2;
            $files2->move(public_path() . '/kumpulan_surat/file_dokumentasi_trantib', $filename2);
            $filename3 = time() . '_3.' . $extension3;
            $files3->move(public_path() . '/kumpulan_surat/file_dokumentasi_trantib', $filename3);
            ...
            DokumentasiTrantib::create([
                ...
                'foto1' => '/kumpulan_surat/file_dokumentasi_trantib/' . $filename1,
                'subfoto1' => '/kumpulan_surat/file_dokumentasi_trantib/' . $filename2,
                'subfoto2' => '/kumpulan_surat/file_dokumentasi_trantib/' . $filename3,
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($request->hasFile('foto1')) {
            ...
            if ($check) {
                ...
                $file->move(public_path() . '/kumpulan_surat/file_dokumentasi_trantib', $filename);
                ...
                $surat->foto1 = '/kumpulan_surat/file_dokumentasi_trantib/' . $filename;
            }
        }
        ...
        if ($request->hasFile('subfoto1')) {
            ...
            if ($check) {
                ...
                $surat->subfoto1 = '/kumpulan_surat/file_dokumentasi_trantib/' . $filename;
            }
        }
        ...
        if ($request->hasFile('subfoto2')) {
            ...
            if ($check) {
                ...
                $surat->subfoto2 = '/kumpulan_surat/file_dokumentasi_trantib/' . $filename;
            }
        }
