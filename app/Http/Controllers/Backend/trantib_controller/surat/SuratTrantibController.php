...
class SuratTrantibController extends Controller
{
    public function index()
    {
        ...
        return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'File Trantib', 'name' => 'trantib.surat']);
    }
    ...
    public function indexPublic()
    {
        ...
        return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'File Trantib - Public', 'name' => 'trantib.surat']);
    }
        ...
        public function indexPrivate()
    {
        ...
        return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'File Trantib - Private', 'name' => 'trantib.surat']);
    }
    ...
    public function category($id)
    {
        try {
            ...
            return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'File Trantib', 'categoryName' => $categoryName, 'name' => 'trantib.surat']);
        } catch (\Throwable $th) {
            return redirect()->route('admin.trantib.index');
        }
    }
    ...
    public function store(Request $request)
    {
        if ($request->hasFile('file')) {
            ...
            if ($check) {
                ...
                $files->move(public_path() . '/kumpulan_surat/file_trantib', $filename);
                ...
                SuratTrantib::create([
                    ...
                    'path_file' => '/kumpulan_surat/file_trantib/' . $filename
                ]);
                return back();
            } else {
                return back();
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            if ($check) {
                ...
                $surat->path_file = '/kumpulan_surat/file_trantib/' . $filename;
            }
        };
