...
class UmpegController extends Controller
{
    public function index()
    {
        ...
        return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'UMPEG', 'name' => 'umpeg']);
    }
    ...
    public function indexPublic()
    {
        ...
        return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'UMPEG - Public', 'name' => 'umpeg']);
    }
        ...
        public function indexPrivate()
    {
        ...
        return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'UMPEG - Private', 'name' => 'umpeg']);
    }
    ...
    public function category($id)
    {
        try {
            ...
            return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'UMPEG', 'categoryName' => $categoryName, 'name' => 'umpeg']);
        } catch (\Throwable $th) {
