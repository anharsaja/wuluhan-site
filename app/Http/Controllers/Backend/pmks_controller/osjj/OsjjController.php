...
class OsjjController extends Controller
{
    public function index()
    {
        ...
        $surat = SuratOsjj::get();
        return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'OSJJ', 'name' => 'osjj']);
    }
    ...
    public function indexPublic()
    {
        ...
        return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'OSJJ - Public', 'name' => 'osjj']);
    }
        ...
        public function indexPrivate()
    {
        ...
        return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'OSJJ - Private', 'name' => 'osjj']);
    }
    ...
    public function category($id)
    {
        try {
            ...
            return view('backend2.pages.berkas.index', ['categories' => $category, 'surats' => $surat, 'title' => 'OSJJ', 'categoryName' => $categoryName, 'name' => 'osjj']);
        } catch (\Throwable $th) {
